...
![Merge Start Animation](/assets/images/merge_sort/Merge Start Animation.png){: width="450" .middle}
_Merge Start Animation_

![Merge Start Animation](/assets/images/merge_sort/Divide and Conquer.png){: width="450" .middle}
_Divide and Conquer_

![Merge Start Animation](/assets/images/merge_sort/Sort and Reconstruction.png){: width="450" .middle}
_Sort and Reconstruction_

![Merge Start Animation](/assets/images/merge_sort/Finished Result.png){: width="450" .middle}
_Finished Result_