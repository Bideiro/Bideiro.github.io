...
![Profile Picture](https://lh3.googleusercontent.com/a/ACg8ocLFEx-JZKGXQRPnOK-ESzh9U9j55Oxw4LjiCP8CkwdhHDbUkAds=s400-c)

## About Me 

I'm a Computer Science graduate passionate about programming and technology. My curiosity about how devices work
led me to explore coding and problem-solving, which grew into a drive to use data science for impact. I enjoy logical
thinking, tackling complex problems, and continuously learning to apply my skills in real-world challenges.


> If you want the resume, [click here](/assets/De_Ocampo_Resume-h2p.pdf).
{: .prompt-info }
...
### College of San Benildo Rizal - Sumulong Highway
( 2015 - 2021 ) Science, Technology, Engineering and Math - <b>STEM</b>

## Certificates 

### CSE - Professional
I passed the test with a general rating of 87.66%.

Below are the comparable performance in each subject areas of the test.

| Verbal (30%)| Analytical(35%)|Numerical(30%)|General Info(5%)|
| :-----------| :------------- | :----------- |:---------------|
| 88.8        | 82.11          | 82.50        |90.00           |


>If you want the electronic pdf, [click here](/assets/CSC-%20Notice%20of%20Rating.pdf).
{: .prompt-info }
